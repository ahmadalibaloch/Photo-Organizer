...
public class UIUtilities {
	...
	// public static void showImageToast(Context context, int id, Drawable
	// drawable) {
	// final View view =
	...
	public static void message(Context c, String text) {
		android.widget.Toast
				.makeText(c, text, android.widget.Toast.LENGTH_LONG).show();
	}
}